...
/**
 * Tests individual methods of the ReliableRobot class. 
 * 
 * 
...
public class ReliableRobotTest {
	...
	/**
	 * Creates default ReliableRobot object and controller object so that the ReliableRobot can be tested.
	 */
	@Before
	public void setUp() {
...
//		StateGenerating tempState = new StateGenerating();
...
//		tempState.control = controller;
//		tempState.panel = controller.getPanel();
		
//		tempState.switchFromGeneratingToPlayingForTesting(controller.getMaze()); // should call all the set ups
...
//		tempState.switchFromGeneratingToPlayingForTesting(controller.getMaze()); // should call all the set ups
	 ...
	 * <p>
	 * Method under test: instance variable fields for isDead, energyLevel, and odometer reading, constructor - ReliableRobot()
	 * <p>
	 * Correct behavior:
	 * It is correct if isDead is false, energyLevel set to full 3500, and odometer set to 0
	 */
	@Test
	public final void startingInstanceVarsReset() {
		...
		// makes sure that instance variable fields for isDead, energyLevel, and odometer reading are all correct
	 ...
	 * <p>
	 * Method under test: addDistanceSensor() method, setDistanceSensorDirection() instance vars for the sensors, setup process for distance sensors
	 * <p>
	 * Correct behavior:
	...
	public final void distanceSensorsAdditions() {
		...
		// tests that the addDistanceSensor() method works, setDistanceSensorDIr() works that the instance variable for the sensors works
