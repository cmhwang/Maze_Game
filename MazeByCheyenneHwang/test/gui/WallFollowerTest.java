...
/**
 * Tests individual methods of the WallFollower class. 
 * 
 * 
...
public class WallFollowerTest { 
	...
	/**
	 * Creates default WallFollower object with no specification. Also creates a robot object so that the full implementation of wallfollower can be tested.
	 */
	@Before
	public void setUp() {
	...
	/**
	 * Resets default WallFollower object with needed cars for testing. makes sure tests don't interfere with each other.
	 */
	@After
	public void reset() {
	...
	/**
	 * Test case: checks to see if a robot has been set for wallfollower
	 * <p>
	 ...
	 * <p>
	 * Correct behavior:
	 * should assert that the wallfollower's robot is the robot created
	 */
	@Test
	public final void settingUpRobot() {
		//checks to see if a robot has been set for wallfollower
	...
	/**
	 * Test case: checks to see if a maze has been set for  wallfollower
	 * <p>
	 ...
	 * <p>
	 * Correct behavior:
	 * should assert that the wallfollower's maze is the maze from the robot created
	 */
	@Test
	public final void settingUpMaze() {
		// checks to see if a maze has been set for  wallfollower
	...
	public final void checkFullDriveWorking() {
		...
		try {
			...
			assertTrue(driver.robot.hasStopped());
		}
	}
	...
	/**
	 * Test case: checks that energyUsed by wallfollower starts at the right value
	 * <p>
	...
	public final void checkEnergyComsumptionStart() {
		// checks that energyUsed by wallfollower starts at the right value
	...
	/**
	 * Test case: checks that energyUsed by wallfollower is correctly updated after a drive
	 * <p>
	...
	public final void checkEnergyConsumptionLater() {
		// checks that energyUsed by wallfollower is correctly updated after a drive
	...
	/**
	 * Test case: checks that pathLength travelled by wallfollower starts at the right value
	 * <p>
	...
	public final void checkPathLengthStart() {
		// checks that pathLength travelled by wallfollower starts at the right value
	...
	/**
	 * Test case: checks to see if drive1step method works when one of the sensors needed (l or f) is in repair and a switch needs to be made
	 * <p>
	...
	public final void drive1stepUnreliableSetting() {
		// checks to see if drive1step method works when one of the sensors needed (l or f) is in repair and a switch needs to be made
	...
	/**
	 * Test case: checks to see if drive1step method works when the setting for the needed sensors (l and f) is true - and thus operates like a reliable sensor
	 * <p>
	...
	public final void drive1stepReliableSetting() {
		// checks to see if drive1step method works when the setting for the needed sensors (l and f) is true - and thus operates like a reliable sensor
	...
	/**
	 * Test case: checks to see that wallfollower is actually trying to follow the left wall
	 * <p>
	 * Method under test:  drive1step method works and by proxy that the drive2end() works
	 * <p>
	 * Correct behavior:
	 * should assert that the wallfollower driver robot along the left wall
	 */
	@Test
	public final void driveActuallyFollowsWall() {
		// checks to see that wallfollower is actually trying to follow the left wall
		...
		// if correctly set up it should assert that the wallfollower driver robot along the left wall
