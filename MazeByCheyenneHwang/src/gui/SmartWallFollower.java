...
/**
 * This is a robot driver algorithm, an extra credit one for project 4
 * 
 ...
 * structure wise similar to WallFollower just with different drive1step2exit that responds to the possibility of rooms and an inner wall
 * strategy used: when in a situation that would get wall follower stuck in a room, turns right 1/2 half time and left the other half so that will most likely not get stuck in loop
...
public class SmartWallFollower extends WallFollower {
	...
	public boolean drive1Step2Exit() throws Exception {
		...
		if (robot.hasStopped()) {
			...
			SmartSensorStatus sensorStatuses = new SmartSensorStatus(this, robot, sensorTracker);
